...
<!-- An xsl template for displaying metadata in ArcInfo8 with the traditional FGDC look and feel created by mp
	...
	Revision History:
		...
		7.  Replaced <p ID="original"><xsl:eval>this.text</xsl:eval></p><SCRIPT>fix(original)</SCRIPT>
		    with <dd><p id="fixvalue"><xsl:value-of select="."/></p></dd>, removing enclosing DIV elements if psent.
...
<xsl:template match="/">
    ...
    <ul>
      ...
      <xsl:for-each select="metadata/spf">
    ...
    <xsl:apply-templates select="metadata/spf"/>
      ...
      <xsl:for-each select="descript">
        ...
        <dl>
          <xsl:for-each select="abstract">            
            <dt><i>Abstract: </i></dt>
            <dd><p id="fixvalue"><xsl:value-of select="."/></p></dd>            
          </xsl:for-each>
              ...
              <xsl:for-each select="planci">
                ...
                <dl>
                  ...
                  <xsl:for-each select="coordrep">
                    <dt><i>Coordinate_Repsentation: </i></dt>
                    <dd>
                    <dl>
                  ...
                  <xsl:for-each select="distbrep">
                    <dt><i>Distance_and_Bearing_Repsentation: </i></dt>
                    <dd>
                    <dl>
              ...
              <xsl:for-each select="attrdomv">
                ...
                <dl>
                  ...
                  <xsl:for-each select="udom">
                    <dt><i>Unrepsentable_Domain: </i></dt>
                    <dd><xsl:value-of select="."/></dd>
                  </xsl:for-each>
                </dl>
                </dd>
...
<xsl:template match="distinfo">
  ...
  <dl>
    ...
    <dl>
              ...
              <xsl:for-each select="digtinfo">
                ...
                <dl>
                  ...
                  <xsl:for-each select="filedec">
                    <dt><i>File_Decompssion_Technique: </i> <xsl:value-of select="."/></dt>
                  </xsl:for-each>
                        ...
                        <dl>
                          ...
                          <xsl:for-each select="dialinst">
                            ...
                            <dl>
                              ...
                              <xsl:for-each select="compss">
                                <dt><i>Compssion_Support: </i> <xsl:value-of select="."/></dt>
                              </xsl:for-each>
      ...
      <xsl:for-each select="techpq">
        <dt><i>Technical_prequisites: </i></dt>
        <dd><xsl:value-of select="."/></dd>
      </xsl:for-each>
...
<xsl:template match="citeinfo">
  ...
  <dl>
    ...
    <xsl:for-each select="geoform">
      <dt><i>Geospatial_Data_psentation_Form: </i> <xsl:value-of select="."/></dt>
    </xsl:for-each>
