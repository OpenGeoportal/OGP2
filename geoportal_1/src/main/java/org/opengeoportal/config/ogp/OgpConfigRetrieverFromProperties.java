...
public class OgpConfigRetrieverFromProperties implements OgpConfigRetriever {
	...
	private static final String TITLE = "ogp.pageTitle";
	...
	//default values
	private static final String TITLE_DEFAULT = "OpenGeoportal";
	...
	public OgpConfig load() throws Exception {
		...
		String pageTitle = getPropertyWithDefault(props, TITLE, TITLE_DEFAULT);
		ogpConfig.setPageTitle(pageTitle);
