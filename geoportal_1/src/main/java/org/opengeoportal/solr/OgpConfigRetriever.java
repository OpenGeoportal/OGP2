...
public class OgpConfigRetriever extends ConfigRetriever implements
	...
	public String getWmsProxy(String institution, String accessLevel)
			throws IOException {
		return this.getWmsProxyInternal(institution, accessLevel) + getProxy(institution, accessLevel, "wms");
	}
	
	@Override
	public String getWfsProxy(String institution, String accessLevel)
			throws IOException {
		return this.getWfsProxyInternal(institution, accessLevel) + getProxy(institution, accessLevel, "wfs");
	}
	...
	public String getWcsProxy(String institution, String accessLevel)
			throws IOException {
		return this.getWcsProxyInternal(institution, accessLevel) + getProxy(institution, accessLevel, "wcs");
