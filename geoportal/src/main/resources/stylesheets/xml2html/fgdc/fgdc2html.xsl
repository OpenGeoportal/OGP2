                        ...
                        <div class="metadataTOC level1">
                            ...
                            <ul>
                                ...
                                <xsl:if test="string-length( metadata/spdoinfo )">
                                    <li>
                                        <a href="#spatialOrg">Spatial Data Organization Information</a>
                                    </li>
                                </xsl:if>
                                <xsl:if test="string-length( metadata/spref )">
                                    <li>
                                        <a href="#spatialRef">Spatial Reference Information</a>
                                    </li>
                                </xsl:if>
                                <xsl:if test="string-length( metadata/eainfo )">
                                    <li>
                                        <a href="#attributeInfo">Entity and Attribute Information</a>
                                    </li>
                                </xsl:if>
                                <li>
