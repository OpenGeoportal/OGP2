...
<xsl:stylesheet
        ...
        <xsl:for-each select="enttyp">
            ...
            <blockquote>
                <xsl:for-each select="enttypl">
                    <p>
                        <b>Entity Type Label:</b>
                        <xsl:value-of select="."/>
                    </p>
                </xsl:for-each>
                <xsl:for-each select="enttypd">
                    <p>
                        <b>Entity Type Definition:</b>
                    </p>
                    <p>
                ...
                <xsl:for-each select="enttypds">
                    <p>
                        <b>Entity Type Definition Source:</b>
                    </p>
                    <p>
                        <xsl:call-template name="replace-newlines">
                            <xsl:with-param name="element" select="."/>
        ...
        <xsl:if test="string-length( attr )">
            ...
            <ul>
                <xsl:for-each select="attr">
                    ...
                    <li>
                        <xsl:text disable-output-escaping="yes">&lt;a href="#attr</xsl:text><xsl:value-of
                            select="attrlabl"/><xsl:text disable-output-escaping="yes">"/&gt;</xsl:text><xsl:value-of
                            select="attrlabl"/><xsl:text disable-output-escaping="yes">&lt;/a&gt;</xsl:text>
                    </li>
                </xsl:for-each>
            </ul>
        </xsl:if>
    ...
    <xsl:template match="attr">
        <xsl:text disable-output-escaping="yes">&lt;a name="attr</xsl:text><xsl:value-of select="attrlabl"/><xsl:text
        ...
        <blockquote>
            ...
            <xsl:for-each select="attrdefs">
                <p>
                    <b>Attribute Definition Source:</b>
                </p>
                <p>
                    <xsl:call-template name="replace-newlines">
                        <xsl:with-param name="element" select="."/>
                    ...
                    <xsl:for-each select="edom">
                        ...
                        <blockquote>
                            <xsl:for-each select="edomv">
                                <p>
                                    <b>Enumerated Domain Value:</b>
                                    <xsl:value-of select="."/>
                                </p>
                            </xsl:for-each>
                            <xsl:for-each select="edomvd">
                                <p>
                                    <b>Enumerated Domain Value Definition:</b>
                                </p>
                                <p>
                                    <xsl:call-template name="replace-newlines">
                                        <xsl:with-param name="element" select="."/>
                            ...
                            <xsl:for-each select="edomvds">
                                <p>
                                    <b>Enumerated Domain Value Definition Source:</b>
                                </p>
                                <p>
                                    <xsl:call-template name="replace-newlines">
                                        <xsl:with-param name="element" select="."/>
                    ...
                    <xsl:for-each select="rdom">
                        ...
                        <blockquote>
                            <xsl:for-each select="rdommin">
                                <p>
                                    <b>Range Domain Minimum:</b>
                                    <xsl:value-of select="."/>
                                </p>
                            </xsl:for-each>
                            <xsl:for-each select="rdommax">
                                <p>
                                    <b>Range Domain Maximum:</b>
                                    <xsl:value-of select="."/>
                                </p>
                            </xsl:for-each>
                            <xsl:for-each select="attrunit">
                                <p>
                                    <b>Attribute Units of Measure:</b>
                                    <xsl:value-of select="."/>
                                </p>
                            </xsl:for-each>
                            <xsl:for-each select="attrmres">
                                <p>
                                    <b>Attribute Measurement Resolution:</b>
                                    <xsl:value-of select="."/>
                                </p>
                            </xsl:for-each>
                            <xsl:apply-templates select="attr"/>
            ...
            <xsl:for-each select="enddatea">
                <p>
                    <b>Ending Date of Attribute Values:</b>
                    <xsl:call-template name="date">
                        <xsl:with-param name="element" select="."/>
                    </xsl:call-template>
                </p>
            ...
            <xsl:for-each select="attrvai">
                <p>
                    <b>Attribute Value Accuracy Information:</b>
                </p>
                <blockquote>
                    <xsl:for-each select="attrva">
                        <p>
                            <b>Attribute Value Accuracy:</b>
                            <xsl:value-of select="."/>
                        </p>
                    </xsl:for-each>
                    <xsl:for-each select="attrvae">
                        <p>
                            <b>Attribute Value Accuracy Explanation:</b>
                        </p>
                        <p>
                            <xsl:call-template name="replace-newlines">
                                <xsl:with-param name="element" select="."/>
            ...
            <xsl:for-each select="attrmfrq">
                <p>
                    <b>Attribute Measurement Frequency:</b>
                </p>
                <p>
                    <xsl:call-template name="replace-newlines">
                        <xsl:with-param name="element" select="."/>
    ...
    <xsl:template match="overview">
        ...
        <xsl:for-each select="eaover">
            <p>
                <b>
                    <i>Entity and Attribute Overview:</i>
                </b>
            </p>
            <p>
                <xsl:call-template name="replace-newlines">
        ...
        <xsl:for-each select="eadetcit">
            <p>
                <b>
                    <i>Entity and Attribute Detail Citation:</i>
                </b>
            </p>
            <p>
                <xsl:call-template name="replace-newlines">
