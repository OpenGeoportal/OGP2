...
/*        var initQuery = this.get("initialQuery");
	...
	getAdvancedSearchQuery : function() {
		...
		params["isoTopic"] = this.getSelected("isoTopicList");

		// originator value needs to be quoted
		if ((params.hasOwnProperty("originator")) && params['originator'] && params['originator'].length > 0) {
			params['originator'] = '"' + params['originator'] + '"';
		}
		return params;
	},
