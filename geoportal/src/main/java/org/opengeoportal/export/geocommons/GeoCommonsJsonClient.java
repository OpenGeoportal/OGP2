...
import org.opengeoportal.metadata.MetadataParser;
import org.opengeoportal.metadata.MetadataParserFactory;
...
public class GeoCommonsJsonClient implements GeoCommonsClient {
    ...
    final Logger logger = LoggerFactory.getLogger(GeoCommonsJsonClient.class);
    ...
    private CreateStreamDataSetRequestJson createStreamDataSetRequestObject(String layerId) {
        ...
        try {
            metadataParser = metadataParserFactory.getMetadataParser(metadataString);
        ...
        try {
            createDataSetRequestJson.setContact_name(cleanString(metadataParser.getContactName()));
        } catch (Exception e) {
            createDataSetRequestJson.setContact_name("OpenGeoportal");
        }
        try {
            createDataSetRequestJson.setContact_address(cleanString(metadataParser.getContactAddress()));
        } catch (Exception e) {
            createDataSetRequestJson.setContact_address("help@opengeoportal.org");
        }
        try {
            createDataSetRequestJson.setContact_phone(cleanString(metadataParser.getContactPhoneNumber()));
        } catch (Exception e) {
            createDataSetRequestJson.setContact_phone("no phone listed");
        }
