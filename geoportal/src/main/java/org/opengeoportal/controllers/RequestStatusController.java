...
import org.opengeoportal.download.types.RequestedLayerStatus;
...
public class RequestStatusController {
	...
	@Autowired
	public RequestStatusController(RequestStatusManager requestStatusManager) {
	...
	public @ResponseBody
    RequestStatus getDownloadStatus(@RequestParam("requestIds") String requestIds) throws IOException  {
